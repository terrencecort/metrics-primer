...
= Tools
On this project we will be using http://www.nagios.org[nagios] to gather system metrics and https://prometheus.io/[prometheus] to gather metrics from openshift, containers and servivces.  
